...
namespace refrigerated_truck
{
    class Program
    {
        ...
        static double baseLon = -122.130137;
        ...
        // User IDs.
        static string IDScope = "0ne002554CD";
        static string DeviceID = "RefrigeratedTruck1";
        static string PrimaryKey = "3mAGeEJNLdYSijzEtblPDjRarMbfcE6RlC2xbZWCQdA=";
        static string AzureMapsKey = "ZqVZVwEWe2bA5HVzme9aeLYwdL2uiNzyiuIuO3huXOk=";
